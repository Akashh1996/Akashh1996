## Hi there, I'm Akash !! - Full Stack Web Developer 👋

```js
const AboutMe = {
  name: "Akash Sapkota",
  age: 24,
  status: "In love with Javascript",
  motto: "Never stop learning",
  skills: {
    general: ["Team work", "Adaptibility", "Leadership", "Problem Solving"],
    technical : {
      frontend: ["HTML", "CSS/SASS", "Javascript", "Typescript","React", "JQuery", "Bootstrap", "Material UI","JSON","XML", "AJAX", "APIs", "Flux", "Redux", "Jest", "TDD", "Postman", "SCRUM", "MIRO", "Figma" ],
      backend : ["Node", "Express", "MongoDB/ATLAS", "EJS", "Mongoose", "JWT", "REST API" ]
    }
  }
}
...
### Connect with me:
[<img align="left" alt="LinkedIn" width="22px" src="https://cdn.jsdelivr.net/npm/simple-icons@v3/icons/linkedin.svg" />](https://www.linkedin.com/in/akash-sapkota-front-end-developer/)
...
![Akash's github stats](https://github-readme-stats.vercel.app/api?username=Akashh1996&show_icons=true)
